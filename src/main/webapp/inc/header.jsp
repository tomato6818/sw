		...
		<div class="header_area">
			<div class="cont_1160">
				...
				<div id="menu">
        	        ...
        	        <li class="one">
  <a href="/content/a_1.jsp" class="oneDep disB">사업단 소개</a>
  <p class="twoDep">
...
<li class="two">
  <a href="/content/b_1.jsp" class="oneDep disB">SW전공자 교육</a>
  <p class="twoDep">
...
<li class="three">
  <a href="/content/c_1.jsp" class="oneDep disB">기초교육 & 융합교육</a>
  <p class="twoDep">
...
<li class="four">
  <a href="/content/d_1.jsp" class="oneDep disB">SW 가치확산</a>
  <p class="twoDep">
...
<li class="five">
  <a href="/board/all" class="oneDep disB">알림마당</a>
  <p class="twoDep">
