<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
    <div class="lnb">
      ...
      <a href="/content/a_6.jsp"><span class="page_row<% if (PAGE_CODE.equals("a_6")) { %> on<% } %>">찾아오시는 길</span></a>
      ...
      <a href="/content/b_6.jsp"><span class="page_row<% if (PAGE_CODE.equals("b_6")) { %> on<% } %>">해외 교육 및 해외 인턴쉽</span></a>
      <a href="/content/b_7.jsp"><span class="page_row<% if (PAGE_CODE.equals("b_7")) { %> on<% } %>">기업-대학 협동과목</span></a>
      ...
      <a href="/bbs/program_list.jsp"><span class="page_row<% if (PAGE_CODE.equals("basic")) { %> on<% } %>">프로그램 접수현황</span></a>
      <% } %>
