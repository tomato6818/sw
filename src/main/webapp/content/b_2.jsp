...
<%
	...
	String PAGE_NAME = "코딩 ABF 제도(조호성)" ; // 페이지 타이틀
%>
...
<%@include file="/inc/navi.jsp"%>
          ...
          <div class="shortcode1-1">
            소프트웨어중심대학사업단에서는 재학생들이 프로그래밍에 대한 최소한의 능력을 갖출 수 있도록 학사제도를 개편하여 2016년부터 "코딩-ABF 제도"를 도입하여 적용하고 있습니다.<br>
            "코딩-ABF 제도"란 1,2학년 동안 프로그래밍 역량을 집중적으로 배양할 수 있도록 프로그래밍 집중형 4개 과목 (SW입문설계, 창의적 SW 프로그래밍, 자료구조, 시스템프로그래밍)에 대하여 B학점 이상 획득을 의무화하도록 하는 제도입니다.<br>
            이 4개 과목들은 절대평가 방식으로 평가되며 수강생들은 A학점, B학점 혹은 F학점만 받을 수 있으며 F학점을 받은 경우 재수강 혹은 계절학기 수강을 통해 반드시 B학점 이상을 받도록 하고 있습니다.
          </div>
